class DefaultData
  ...
  def teachers
    result = []
    result << Teacher.create(name: 'Giuseppe', surname: 'Musso', subjects: %w(Maths Geometry), user: User.find_by(email: 'u1@p.it')).id
  ...
  def assignments
    ...
    result << Assignment.create(name: 'Math: ex. 1, 2, 3', expiry_date: Date.new(2019, 12, 24), subject: 'Math', school_class: SchoolClass.find_by(number: 1, section: 'A'), teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), lecture: Lecture.find_by(name: 'Lecture 1', topics: 'Sum operation', subject: 'Math', teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), school_class: SchoolClass.find_by(number: 1, section: 'A'))).id
    result << Assignment.create(name: 'Math: ex. 4, 5, 6', expiry_date: Date.new(2019, 12, 23), subject: 'Math', school_class: SchoolClass.find_by(number: 1, section: 'A'), teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), lecture: Lecture.find_by(name: 'Lecture 1', topics: 'Sum operation', subject: 'Math', teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), school_class: SchoolClass.find_by(number: 1, section: 'A'))).id

    result << Assignment.create(name: 'Math: ex. 19, 20', expiry_date: Date.new(2019, 12, 24), subject: 'Math', school_class: SchoolClass.find_by(number: 2, section: 'A'), teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), lecture: Lecture.find_by(name: 'Lecture 1', topics: 'Fractions', subject: 'Math', teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), school_class: SchoolClass.find_by(number: 2, section: 'A'))).id
    result << Assignment.create(name: 'Math: ex. 21', expiry_date: Date.new(2019, 12, 23), subject: 'Math', school_class: SchoolClass.find_by(number: 2, section: 'A'), teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), lecture: Lecture.find_by(name: 'Lecture 1', topics: 'Fractions', subject: 'Math', teacher: Teacher.find_by(name: 'Giuseppe', surname: 'Musso'), school_class: SchoolClass.find_by(number: 2, section: 'A'))).id

    result << Assignment.create(name: 'Biology: ex. 2', expiry_date: Date.new(2019, 12, 19), subject: 'Biology', school_class: SchoolClass.find_by(number: 2, section: 'A'), teacher: Teacher.find_by(name: 'Maria', surname: 'Cerrato'), lecture: Lecture.find_by(name: 'Lecture 1', topics: 'Digestive system', subject: 'Biology', teacher: Teacher.find_by(name: 'Maria', surname: 'Cerrato'), school_class: SchoolClass.find_by(number: 2, section: 'A'))).id
    result << Assignment.create(name: 'Biology: ex. 11', expiry_date: Date.new(2019, 12, 11), subject: 'Biology', school_class: SchoolClass.find_by(number: 2, section: 'A'), teacher: Teacher.find_by(name: 'Maria', surname: 'Cerrato'), lecture: Lecture.find_by(name: 'Lecture 1', topics: 'Digestive system', subject: 'Biology', teacher: Teacher.find_by(name: 'Maria', surname: 'Cerrato'), school_class: SchoolClass.find_by(number: 2, section: 'A'))).id
